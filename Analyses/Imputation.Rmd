...
# Import the data
```{r data}
dat_raw <- read_sav("data_correctlycoded_GV.zsav") %>% zap_labels()
```
...
vars_fixed <- c("edu", "geboortejaar", "q29", "q52", "q53", "q54", "sekse", "etn_herkomst")
...
```{r filter}
# select the analysis variables and covariates
dat_clean <- dat_long[c(vars_analyse, vars_covariates)]
